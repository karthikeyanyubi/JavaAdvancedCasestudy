...
public class GlobalExceptionHandler {
    ...
    public final ResponseEntity<Object> handleHttpClientExceptions(HttpClientErrorException exception) {
        LOGGER.error("Exception : " + exception.getMessage() + " Time :"+new Date());
        HashMap<String, Object> result = new HashMap<>();
        ...
        result.put("error", exception.getMessage());
        return new ResponseEntity<>(result, exception.getStatusCode());
    }
